...
export function BookEditor({ book, fileHandle, onBookChange, onSave }: BookEditorProps) {
  return (
    <EditorProvider book={book} fileHandle={fileHandle} onBookChange={onBookChange}>
