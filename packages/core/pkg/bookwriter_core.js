 ...
 * @returns {any}
 */
export function parse_bk(input, created_at, updated_at) {
    const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(created_at) ? 0 : passStringToWasm0(created_at, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
    var ptr2 = isLikeNone(updated_at) ? 0 : passStringToWasm0(updated_at, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len2 = WASM_VECTOR_LEN;
    const ret = wasm.parse_bk(ptr0, len0, ptr1, len1, ptr2, len2);
    if (ret[2]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('bookwriter_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
