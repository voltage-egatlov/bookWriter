...
function getInitialState(book: Book): EditorState {
  return {
    book,
...
export function EditorProvider({ children, book, onBookChange }: EditorProviderProps) {
  const [state, dispatch] = useReducer(editorReducer, getInitialState(book))
